defmodule NewRelic.Plug.Repo do
  ...
  defmacro __using__(opts) do
    quote bind_quoted: [opts: opts] do
      ...
      @spec get_by(Ecto.Queryable.t(), Keyword.t() | Map.t(), Keyword.t()) ::
      ...
      @spec insert(Ecto.Schema.t() | Ecto.Changeset.t(), Keyword.t()) ::
      ...
      @spec insert_or_update(Ecto.Changeset.t(), Keyword.t()) ::
              {:ok, Ecto.Schema.t()} | {:error, Ecto.Changeset.t()}
      ...
      @spec delete(Ecto.Schema.t(), Keyword.t()) ::
              {:ok, Ecto.Schema.t()} | {:error, Ecto.Changeset.t()}
      ...
      @spec preload([Ecto.Schema.t()] | Ecto.Schema.t(), preloads :: term) ::
